...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function () awful.spawn.with_shell("pamixer --list-sinks | awk '{print $1}' | tail -n +2 | xargs -L 1 pamixer -t --sink") end,
              {description = "toggle mute", group = "media"}),

    awful.key({}, "XF86AudioLowerVolume", function () awful.spawn.with_shell("pamixer --list-sinks | awk '{print $1}' | tail -n +2 | xargs -L 1 pamixer -d 2 --sink") end,
              {description = "volume down", group = "media"}),

    awful.key({}, "XF86AudioRaiseVolume", function () awful.spawn.with_shell("pamixer --list-sinks | awk '{print $1}' | tail -n +2 | xargs -L 1 pamixer -i 2 --sink") end,
              {description = "volume up", group = "media"}),

    awful.key({}, "XF86AudioNext", function () awful.spawn.with_shell("dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next") end,
              {description = "next", group = "media"}),

    awful.key({}, "XF86AudioPrev", function () awful.spawn.with_shell("dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous") end,
              {description = "previous", group = "media"}),

    awful.key({}, "XF86AudioPlay", function () awful.spawn.with_shell("dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause") end,
              {description = "play", group = "media"}),

    awful.key({}, "XF86AudioPause", function () awful.spawn.with_shell("dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause") end,
...
awful.spawn.easy_async("redshift -PO 1500K")
awful.spawn.easy_async("nextcloud")
