...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; in emacs 27.
   ;; (default (* 1024 1024))
   dotspacemacs-read-process-output-max (* 1024 1024 4000)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  (add-to-list 'load-path "~/.spacemacs-path/")
)
...
before packages are loaded."
  ...
  ;; this, for some reason, breaks helm, or at least breaks SPC f e d
  ...
  (setq current-time-format "%d/%m/%y")
  ...
  ;; (defun insert-prod-log-entry ()
  ;;   "insert a template for a productivity log entry into the current buffer."
  ;;   (interactive)
  ;;   ())
  ;; ;; (global-set-key "\C-c\C-v" 'insert-current-time)
  ...
  (use-package lsp-mode
    ...
    (setq read-process-output-max (* 1024 1024 500)) ;; 1MB
...
point."
  ...
  (spacemacs/set-leader-keys "ot" 'insert-type)
